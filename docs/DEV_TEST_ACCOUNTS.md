...
Since the automatic seeding had database schema issues, here are the test account details you can create manually using the signup form:
...
The authentication system is fully functional - you just need to create the first owner account manually through the UI.