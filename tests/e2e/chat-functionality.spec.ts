...
test.describe('Chat Functionality', () => {
  ...
  test('should send a message (mock mode)', async ({ page }) => {
    ...
    await expect(page.locator('text=Hello, can you help me with testing?')).toBeVisible();
  ...
  test('should handle long messages', async ({ page }) => {
    const longMessage = 'This is a very long message that should test the textarea expansion and message handling capabilities of the chat interface. '.repeat(10);
  ...
  test('should handle network errors gracefully', async ({ page }) => {
    ...
    const errorIndicator = page.locator('[data-testid="error-message"], text=error, text=failed');
