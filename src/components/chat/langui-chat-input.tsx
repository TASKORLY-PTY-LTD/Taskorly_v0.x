      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between mt-2 px-1">
          <p className="text-xs text-slate-500">
            Press <kbd className="px-1.5 py-0.5 text-xs bg-slate-100 rounded border">Enter</kbd> to send, <kbd className="px-1.5 py-0.5 text-xs bg-slate-100 rounded border">Shift</kbd> + <kbd className="px-1.5 py-0.5 text-xs bg-slate-100 rounded border">Enter</kbd> for new line
          </p>
