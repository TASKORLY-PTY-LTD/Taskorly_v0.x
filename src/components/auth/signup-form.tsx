...
export function SignupForm({ onSignupSuccess, onSwitchToLogin, className }: SignupFormProps) {
  ...
  const isPasswordValid = passwordValidation.length === 0 && formData.password.length > 0;
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select 
              value={formData.role} 
              onValueChange={(value: 'owner' | 'admin' | 'manager' | 'user') => handleInputChange('role', value)}
              disabled={signupMutation.isPending}
            >
              <SelectTrigger>
                <SelectValue />
              ...
              <SelectContent>
                <SelectItem value="owner">Business Owner - Create new organization</SelectItem>
                <SelectItem value="user" disabled>Team Member - Join existing organization</SelectItem>
              </SelectContent>
            </Select>
