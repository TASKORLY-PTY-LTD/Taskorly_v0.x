        ...
        <header className='flex items-center justify-between p-6'>
          ...
          <div className='flex items-center space-x-3'>
            ...
            <Button
              ...
              className='border-white bg-blue-800/50 hover:border-white hover:bg-blue-700/70 text-white hover:text-white'
            >
                ...
                <div className='flex flex-wrap gap-2 justify-center'>
                  {SAMPLE_QUESTIONS.map((question, index) => (
                    <Button
                      ...
                      className='text-xs border-white bg-blue-800/30 hover:border-white hover:bg-blue-700/50 text-white hover:text-white'
                    >
                      {question}
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {MOCK_SUGGESTIONS.map(suggestion => (
                        <Button
                          ...
                          className='text-xs border-white bg-blue-800/50 hover:border-white hover:bg-blue-700/70 text-white hover:text-white hover:shadow-lg hover:shadow-white/25'
                        >
                          {suggestion.icon}
                ...
                <div className='p-4'>
                  ...
                  <div className='mt-4 pt-4 border-t border-slate-700/50'>
                    ...
                    <Button
                      ...
                      className='w-full justify-start border-white bg-blue-800/30 hover:border-white hover:bg-blue-700/50 text-white hover:text-white'
                    >
