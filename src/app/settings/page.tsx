...
export default function SettingsPage() {
  ...
  const [settings, setSettings] = useState({
    ...
    maxTokens: 4096,
    temperature: 0.7,
    systemPrompt: "You are a helpful AI assistant that provides accurate information based on the provided documents.",
    authRequired: true,
    sessionTimeout: 24,
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Require users to authenticate</p>
                </div>
                <Switch
                  id="authRequired"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Enable data encryption at rest</p>
                </div>
                <Switch
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Show system status alerts</p>
                </div>
                <Switch
                  id="systemAlerts"
